...
const drugdata = document.getElementById('createtransporter')
drugdata.addEventListener('submit', (e) => {
  e.preventDefault()
  let drugData = JSON.stringify($('#createtransporter').serializeObject())
  console.log(drugData)
  ddata=JSON.parse(drugData)
  ddata.organisationRole="Transporter"
  ddata.organisationRole1="Transporter"
